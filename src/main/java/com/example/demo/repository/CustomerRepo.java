...
public interface CustomerRepo extends JpaRepository<Customer, Long> {
	...
	Integer updateCustomer(String cfname, String clname, String addr, String email, Long cont, String country,
			String state, String city, String gst, Long pin, Long cid);
}
